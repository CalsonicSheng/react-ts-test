...
// Batching state update: multiple state updates in React can occur in a batch through a SINGLE event handling or lifecycle callback call through a single re-render instead of multiple ones.
